...
var cheerioFile = function(buffer) {
...
var grade = function(buffer) {
    var checkJson = checkFile(buffer, program.checks);
...
if(require.main == module) {
    ...
    if(program.file) {
      ...
      rest.get(program.url).on('complete', function(data, response) {
       ...
       console.log("Please provide a file or url to grade.");
       process.exit(1);
    }
} else {
